pipeline {
  ...
  post {
    ...
    always {
      ...
      deleteDir()
      emailext from: "mayquanxi@gmail.com" to: "mayquanxi@gmail.com", subject: "always send admin", recipientProviders: [[$class: 'DevelopersRecipientProvider'], [$class: 'RequesterRecipientProvider']], body: "This is always run"
    }
    failure {
