pipeline {
  ...
  post {
    ...
    always {
      ...
      deleteDir()
      emailext to: "mayquanxi@gmail.com", subject: "always send admin", recipientProviders: [[$class: 'DevelopersRecipientProvider'], [$class: 'RequesterRecipientProvider']], body: "This is always run"
    }
    failure {
